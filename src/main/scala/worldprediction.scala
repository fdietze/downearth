...
val vn1_perlinnoise3_uid4e4afc52 = perlinnoise3_uid4e4afc52(vn14_scalesrcv_uid4e4afc52, Interval(0,0), Interval(0,0), Interval(0,0), vn29_sphere_uid4e4afc52, Interval(0,0), 0.5743491774985172, 205.0738886629432, -0.43999999999999995)
...
val vn11_perlinnoise3_uid4e4afc52 = perlinnoise3_uid4e4afc52(vn14_scalesrcv_uid4e4afc52, Interval(0,0), Interval(0,0), Interval(0,0), vn20_sphere_uid4e4afc52, Interval(0,0), 0.05593906693299827, 0.5743491774985175, 0.0)
