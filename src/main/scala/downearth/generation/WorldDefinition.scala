...
def material__3(r:Double, g:Double, b:Double):Material = {Material("ErdeGetrocknet",r,g,b)}
def material__2(r:Double, g:Double, b:Double):Material = {Material("Schotter",r,g,b)}
...
def material__1(r:Double, g:Double, b:Double):Material = {Material("Stein",r,g,b)}
def scalesrcz_uid51b9c303(scale:Double):Double = {world.z * scale}
