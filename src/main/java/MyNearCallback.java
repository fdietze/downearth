 ...
 * @author jezek2
 */
public class MyNearCallback extends NearCallback {
	...
	public void handleCollision(BroadphasePair collisionPair, CollisionDispatcher dispatcher, DispatcherInfo dispatchInfo) {
		...
		if (dispatcher.needsCollision(colObj0, colObj1)) {
			//System.out.println("needsCollision");
			...
			if (collisionPair.algorithm != null) {
				...
				if(contactPointResult.getPersistentManifold() != null)
					System.out.println(" contact points: " + contactPointResult.getPersistentManifold().getNumContacts());
					System.out.println(" algorithm: " + collisionPair.algorithm);
					System.out.println(" colobjects: " + colObj0 + "  " + colObj1);
